...
Indie::Scenes::BResume::BResume(Indie::Game &game, State &state, Vector2 size, Vector2 position, std::string text, int fontSize, Font font,
...
void Indie::Scenes::BResume::run()
{
    _btnAction = true;
    _State.setGameScene(Indie::Scenes::Hud);
    std::cerr << "SHud" << std::endl;
}